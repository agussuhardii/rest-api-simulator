...
@Slf4j
@Validated
public class FivePathController {

  private final RestService restService;

  @PostMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}")
  ...
  @GetMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}")
  ...
  @PutMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}")
  ...
  @DeleteMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}")
