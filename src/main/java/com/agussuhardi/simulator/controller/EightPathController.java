...
@Slf4j
@Validated
public class EightPathController {

  private final RestService restService;

  @PostMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}/{eighth}")
  ...
  @GetMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}/{eighth}")
  ...
  @PutMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}/{eighth}")
  ...
  @DeleteMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}/{eighth}")
