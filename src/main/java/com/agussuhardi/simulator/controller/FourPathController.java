...
@Slf4j
@Validated
public class FourPathController {

  private final RestService restService;

  @PostMapping(value = "{first}/{second}/{third}/{fourth}")
  ...
  @GetMapping(value = "{first}/{second}/{third}/{fourth}")
  ...
  @PutMapping(value = "{first}/{second}/{third}/{fourth}")
  ...
  @DeleteMapping(value = "{first}/{second}/{third}/{fourth}")
