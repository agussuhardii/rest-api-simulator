...
@Slf4j
@Validated
public class SevenPathController {

  private final RestService restService;

  @PostMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}")
  ...
  @GetMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}")
  ...
  @PutMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}")
  ...
  @DeleteMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}/{seventh}")
