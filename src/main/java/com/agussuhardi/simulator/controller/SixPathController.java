...
@Slf4j
@Validated
public class SixPathController {

  private final RestService restService;

  @PostMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}")
  ...
  @GetMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}")
  ...
  @PutMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}")
  ...
  @DeleteMapping(value = "{first}/{second}/{third}/{fourth}/{fifth}/{sixth}")
